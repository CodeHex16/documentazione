...
#show: doc => documento(
  ...
  versioni: ("0.1.0", "12/11/2024", "Francesco Fragonas", "Prima stesura", "Matteo Bazzan",),
  doc,
)
...
#link("https://github.com/CodeHex16/documentazione/tree/main/glossario/glossario.pdf")[Glossario.pdf] e nella seguente pagina web: #link("https://codehex16.github.io/glossario")
...
*Postcondizioni:*\
- Il sistema ha ricevuto le credenziali inviate dall’utente/admin, e se sono valide permette l'accesso dell'utente/admin alla web-app e ai suoi servizi;\
*Scenario Principale:*\

...
// TODO: probabilmente numerazione su un solo livello (tipo UC99 e non 1.99)
...
- Il sistema riceve la richiesta di cambio password e, se è valida, la effettua;
*Estensioni:*
- Sistema non raggiungibile;
*Inclusioni:*
- Inserimento password;

...
\
Con il presente documento il gruppo CodeHex16 intende presentare la propria candidatura per la Requirements and
Technology Baseline (RTP) per il capitolato C7:\
#align(center)[*Assistente virtuale*]\
Proposto dall'azienda Ergon.\
Tutta la documentazione scritta fino alla fase RTB è disponibile al seguente link:\

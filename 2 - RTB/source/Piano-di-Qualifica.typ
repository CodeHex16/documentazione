...
#figure(
  ...
  table(
    ...
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPC-RS", "Requirements Stability Index", "\u{2265}80%", "100%",
    "MPC-TD", "Technical Debt Ratio", "\u{2264}15%", "\u{2264}5%",
  ),
)
...
#figure(
  ...
  table(
    ...
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPC-IG", "Indice di Gulpease", "\u{2265}40", "\u{2265}60",
...
#figure(
  caption: [Valori per misurare la qualità del processo di verifica],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPC0000", "Code coverage", "\u{2265}90%", "100%",
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di funzionalità],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    ...
    "MPD-OP", "Copertura requisiti opzionali", "\u{2265}50%", "100%",
  ),
)
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di affidabilità],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPD-CC", "Code coverage", "\u{2265}80%", "100%",
    "MPD-BC", "Branch coverage", "\u{2265}50%", "\u{2265}80%",
    "MPD-SC", "Statement coverage", "\u{2265}60%", "\u{2265}80%",
    "MPD-FT", "Failure Tolerance", "100%", "100%",
    "MPD-FF", "Failure Frequency", "0", "0",
    "MPD-MTBF", "Mean Time Between Failures", "\u{2265}48h", "\u{2265}72h",
    "MPD-DS", "Disponibilità sistema", "\u{2265}90%", "\u{2265}99.9%",
  ),
)
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di usabilità],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPD-TA", "Tempo di apprendimento", "\u{2264}15 min (utente base)", "\u{2264}5 min",
    "MPD-EUA", "Errori utente/azione", "\u{2264}0.5 errori/azione", "0",
    "MPD-TSR", "Task success rate", "\u{2265}75%", "100%",
  ),
)
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di efficienza],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPD-TRA", "Tempo risposta API", "\u{2264}500 ms", "\u{2264}200 ms",
    "MPD-MP", "Memoria processo", "\u{2264}512 MB", "\u{2264}256 MB",
    "MPD-CE", "Consumo energetico", "\u{2264}2% batteria/min", "\u{2264}1% batteria/min",
  ),
)
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di manutenibilità],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPD-CCL", "Complessità ciclomatica", "\u{2264}15 per modulo", "\u{2264}10",
    "MPD-DT", "Debito Tecnico", "\u{2264}15%", "\u{2264}5%",
    "MPD-CSD", "Code Smell density", "\u{2264}5 smell/100 righe", "0 smell",
    "MPD-TFB", "Tempo fix bug", "\u{2264}4 ore (critico)", "\u{2264}2 ore",
  ),
)
...
#figure(
  caption: [Valori per misurare la qualità del prodotto in termini di sicurezza],
  table(
    columns: (auto, auto, auto, auto),
    inset: 8pt,
    align: (x, y) => if (x == 0 and y > 0 and y < 7) { left } else { center + horizon },
    fill: (x, y) => if (y == 0) { luma(230) },
    table.header([*Metrica*], [*Nome*], [*Valore accettabile*], [*Valore ottimo*]),
    "MPD-AF", "Tasso di autenticazione fallita", "\u{2264}5%", "\u{2264}1%",
...
== Introduzione
In questa sezione vengono riportati tutti i problemi riscontrati dal gruppo durante lo svolgimento del progetto. Per ogni problema viene indicato il periodo in cui è stato riscontrato, la descrizione del problema, l'azione correttiva adottata.

...
#figure(
  ...
  table(
    ...
    "Tutto il progetto",
    "È risultato difficile lavorare sugli stessi documenti in maniera sincrona o senza che più persone scrivessero nella stessa sezione sovrascrivendo il alvoro di altri",
    "Si è deciso di utilizzare diversi branch su git, ognuno dedicato ad ogni lavoro per ogni sprint, in questo modo è stato più facile trovare sezioni sovrascritte e verificare solo le parti cambiate del documento",
    "Inizio progetto",
...
#figure(
  ...
  table(
    ...
    "È stato deciso di assegnare i ruoli in maniera arbitraria in base alle attività da svolgere del singolo membro",
    "Inizio progetto",
    "Verificatore",

...
#figure(caption: [Esempi di unit test], table(
  ...
  "Superato",
  "TU-002",
  "Test recupero utenti",
  "Superato",
  "TU-003",
  "Test aggiornamento dati utente con gestione errori",
  "Superato",
  "TU-004",
  "Test cancellazione utente",
  "Superato",
  "TU-005",
  "Test aggiornamento password utente",
  "Superato",
  "TU-006",
  ...
  "Superato",
  "TU-008",
  "Test token inizializzazione utente",
  "Superato",
  "TU-009",
  "Test gestione token JWT",
  "Superato",
  "TU-010",
  "Test sul ruolo fornitore/cliente del token",
  "Superato",
  "TU-011",
  "Test della funzione 'ricordami' del token durante il login",
  "Superato",
  "TU-012",
  "Test sulla verifica token",
  "Superato",
  "TU-013",
  "Test creazione di una nuova chat",
  "Superato",
  "TU-014",
  "Test recupero chat utente",
  "Superato",
  //"","Verifica cambio nome chat","",
  "TU-015",
  "Test eliminazione chat",
  "Superato",
  "TU-016",
  "Test invio messaggio al bot",
  "Superato",
  "TU-017",
  "Test recupero messaggio da una chat",
  "Superato",
  "TU-018",
  "Test sulla valutazione di un messaggio del chatbot",
  "Superato",
  "TU-019",
  "Test sul caricamento di un documento con gestione di errori",
  "Superato",
  "TU-020",
  "Test sul recupero di un documento",
  "Superato",
  "TU-021",
  "Test sull'eliminazione di un documento con gestione errori",
  "Superato",
  "TU-022",
  "Test sulla creazione di una FAQ",
  "Superato",
  "TU-023",
  "Test sul recupero di una FAQ",
  "Superato",
  "TU-024",
  "Test sull'aggiornamento di una FAQ",
  "Superato",
  "TU-025",
  "Test eliminazione di una FAQ",
  "Superato",
  // repositories
  "TU-026",
  "Test ritorno delle chat associate a un utente",
  "Superato",
  "TU-027",
  "Test ritorno di una chat dato un ID e un'email",
  "Superato",
  "TU-028",
  "Test creazione di una chat con il messaggio iniziale",
  "Superato",
  "TU-029",
  "Test che una chat sia eliminata correttamente",
  "Superato",
  "TU-030",
  "Test che una chat sia aggiornata correttamente",
  "Superato",
  "TU-031",
  "Test aggiunta di un nuovo messaggio alla chat con dati corretti",
  "Superato",
  "TU-032",
  "Test che il titolo di una chat sia aggiornato correttamente",
  "Superato",
  "TU-033",
  "Test sul corretto aggiornamento del rating messaggio",
  "Superato",
  "TU-034",
  "Test sul corretto inserimento di una FAQ",
  "Superato",
  "TU-035",
  "Test sull'aggiornamento corretto di una FAQ",
  "Superato",
  "TU-036",
  "Test eliminazione di una chat",
  "Superato",
  "TU-037",
  "Test sul corretto ritorno dell'email dell'utente",
  "Superato",
  "TU-038",
  "Test sul corretto inserimento di un utente",
  "Superato",
  "TU-039",
  "Test sull'aggiunta di utenti e admin di test",
  "Superato",
  "TU-040",
  "Test sul recupero di utenti e admin di test",
  "Superato",
  // tests
  "TU-041",
  "Test sull'inizializzazione del database",
  "Superato",
  "TU-042",
  "Test sul corretto ritorno dell'oggetto del database",
  "Superato",
  "TU-043",
  "Test sull'hash della password, sul prefisso e verifica che sia diverso dalla password stessa",
  "Superato",
  "TU-044",
  "Test sul parsing della password",
  "Superato",
  "TU-045",
  "Test sulla generazione dello stesso UUID3 per lo stesso testo e UUID3 diversi per testi diversi",
  "Superato",
  "TU-046",
  "Test sulla generazione dello stesso ObjectId per lo stesso testo e ObjectId diversi per testi diversi",
  "Superato",
  "TU-047",

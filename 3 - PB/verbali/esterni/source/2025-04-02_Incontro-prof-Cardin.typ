...
documento #gloss[Analisi dei requisiti], in quanto il gruppo non aveva ben chiari alcuni punti.

= Domande e dubbi posti
#set enum(numbering: "Q1.", spacing: 1.5em)

+ _Non è chiara la correzione sull'inclusione tra gli #gloss[use case] 8 e 34._\
...
+ _Sono sorti dei dubbi su quali pattern era possibile usare con il #gloss[frontend], più precisamente con #gloss[Svelte] in questo caso._\
  Svelte porta all'utilizzo del design pattern "Model View Controller", per questo il professore ha 
  consigliato di continuare a usare i pattern #gloss[standard] di Svelte.

+ _Sono sorti dei dubbi su come rappresentare il grafico #gloss[UML] delle classi per il frontend._\

...
+ _E' necessario usare un logo in particolare?_\
  No, si può il logo del gruppo anche perché in fase di utilizzo ogni istanza del'app sarà personalizzata in base al fornitore; nonostante questo potrebbe essere interessante dare la possibilità al fornitore di scegliere logo e impostare una palette colori per il suo #gloss[chatbot].
